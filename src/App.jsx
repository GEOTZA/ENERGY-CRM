...
{/* Sidebar */}
<div className={`fixed left-0 top-0 h-screen bg-white border-r border-gray-200 p-6 flex flex-col transition-all duration-300 z-40 ${ sidebarOpen ? 'w-64' : 'w-0 -translate-x-full' }`}>
{/* Logo */}
<div className="mb-8">
